...
export default function DeliveryLayout() {
  ...
  const navItems = [
    { path: '/delivery', label: 'My Jobs', icon: '🚚' },
    { path: '/delivery/available', label: 'Find Jobs', icon: '🔍' },
  ...
  return (
    <div style={{ paddingBottom: '80px', minHeight: '100vh', backgroundColor: 'var(--color-background)' }}>
      {/* Top Bar */}
      <header style={{
        backgroundColor: '#F59E0B', // Amber color for delivery
        color: 'white',
        padding: '16px',
        display: 'flex',
        ...
        <div style={{ fontWeight: 700, fontSize: '18px' }}>🚚 Delivery Partner</div>
